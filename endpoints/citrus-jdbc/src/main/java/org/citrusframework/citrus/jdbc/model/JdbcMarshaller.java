...
package org.citrusframework.citrus.jdbc.model;
...
public class JdbcMarshaller implements Marshaller, Unmarshaller {
    ...
    public JdbcMarshaller() {
        ...
        this.marshaller = new Jaxb2Marshaller(new ClassPathResource("org/citrusframework/citrus/schema/citrus-jdbc-message.xsd"), classesToBeBound);
