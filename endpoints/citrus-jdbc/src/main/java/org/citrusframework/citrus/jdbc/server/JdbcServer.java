...
public class JdbcServer extends AbstractServer {
    ...
    private org.citrusframework.citrus.db.server.JdbcServer jdbcServer;
    ...
    protected void startup() {
        ...
        this.jdbcServer = new org.citrusframework.citrus.db.server.JdbcServer(controller, endpointConfiguration.getServerConfiguration());
