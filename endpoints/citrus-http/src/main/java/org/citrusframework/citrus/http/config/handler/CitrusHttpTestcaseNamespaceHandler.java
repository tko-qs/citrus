...
import org.citrusframework.citrus.http.config.xml.HttpReceiveRequestActionParser;
import org.citrusframework.citrus.http.config.xml.HttpReceiveResponseActionParser;
import org.citrusframework.citrus.http.config.xml.HttpSendRequestActionParser;
import org.citrusframework.citrus.http.config.xml.HttpSendResponseActionParser;
